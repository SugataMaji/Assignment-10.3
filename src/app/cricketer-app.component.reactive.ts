...
export class AppComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.myForm = this.fb.group({
      'firstName': ['', Validators.compose([Validators.pattern('^[a-zA-Z]*$'), Validators.required, Validators.minLength(2)])],
      'lastName': this.lastName,
      'designation': ['', Validators.compose([Validators.pattern('^[a-zA-Z]*$'), Validators.required, Validators.minLength(3)])],
